  ...
  return (
    <div className="flex flex-col items-center gap-5 sm:flex-row sm:items-center sm:gap-8">
      <div className="relative shrink-0">
        <svg viewBox="0 0 140 140" className="w-40 h-40 sm:w-44 sm:h-44 drop-shadow-sm">
      ...
      {items.map((i) => (
        <div key={i.nombre} className="space-y-1">
          ...
          <div className="flex h-3 w-full overflow-hidden rounded-full bg-brand-mist ring-1 ring-brand-ink/5">
            <span
              className="h-full rounded-l-full bg-gradient-to-r from-brand-deep to-brand-cyan"
      ...
      {serie.map((d) => (
        <div key={d.clave} className="flex flex-1 flex-col items-center justify-end gap-1 h-full">
          <div className="flex items-end gap-[3px] w-full">
            <span
              className="flex-1 rounded-t-md bg-gradient-to-t from-brand-deep to-brand-cyan"
